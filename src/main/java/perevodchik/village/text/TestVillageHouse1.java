...
public class TestVillageHouse1 extends StructureVillagePieces.Village{

    /**
     * Instantiates a new village house cloud.
     */
    public TestVillageHouse1()
    {
    }
     ...
     */
    public TestVillageHouse1(StructureVillagePieces.Start parStart, int parType, Random parRand, StructureBoundingBox parStructBB, EnumFacing parFacing)
    {
    ...
    public boolean addComponentParts(World parWorld, Random parRand, StructureBoundingBox parStructBB)
    {
        ...
        IBlockState wallBlockState = getBiomeSpecificBlockState(Blocks.ACACIA_STAIRS.getDefaultState());
        ...
        IBlockState stateStairsSouth = getBiomeSpecificBlockState(Blocks.DIAMOND_ORE.getDefaultState().withProperty(BlockStairs.FACING, EnumFacing.SOUTH));
        IBlockState stateStairsEast = getBiomeSpecificBlockState(Blocks.DIAMOND_ORE.getDefaultState().withProperty(BlockStairs.FACING, EnumFacing.EAST));
        IBlockState stateStairsWest = getBiomeSpecificBlockState(Blocks.DIAMOND_ORE.getDefaultState().withProperty(BlockStairs.FACING, EnumFacing.WEST));
        IBlockState statePlanks = getBiomeSpecificBlockState(Blocks.PLANKS.getDefaultState());
        IBlockState stateLog = getBiomeSpecificBlockState(Blocks.ACACIA_STAIRS.getDefaultState());
    ...
    {
        return ProfessionsEvent.mysterious_stranger;
    }
}