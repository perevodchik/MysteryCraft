...
public class TestVillageHouse extends StructureVillagePieces.Village{

    /**
     * Instantiates a new village house cloud.
     */
    public TestVillageHouse()
    {
    }
     ...
     */
    public TestVillageHouse(StructureVillagePieces.Start parStart, int parType, Random parRand, StructureBoundingBox parStructBB, EnumFacing parFacing)
    {
