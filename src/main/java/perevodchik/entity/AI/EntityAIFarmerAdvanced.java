...
public class EntityAIFarmerAdvanced extends EntityAIMoveToBlock {
    /** Villager that is harvesting */
    private final EntityModVillager villager;
    private boolean hasFarmItem;
    private boolean wantsToReapStuff;
    /** 0 => harvest, 1 => replant, -1 => none */
    private int currentTask;

    public EntityAIFarmerAdvanced(EntityModVillager villager, double speedIn) {
        super(villager, speedIn, 20);
